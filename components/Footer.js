      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">Video Processor</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Transform your videos into concise, actionable summaries with our AI-powered video processing service.
            </p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            © {new Date().getFullYear()} Video Processor. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
